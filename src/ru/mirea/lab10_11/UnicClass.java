...
public class UnicClass<T>{
    ...
    public UnicClass(int size) {
        this.size = size;
        l = (T[]) new Object[size];
        count = 0;
    }

    public UnicClass(UnicClass<T> other){
    ...
    public boolean addAll(int index, UnicClass<T> other){
    ...
    public UnicClass<T> subList(int start, int end){
        UnicClass<T> nl = new UnicClass<>();
